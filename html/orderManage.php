...
<!--                 <th>订单总价</th>
        ...
        <div style="float: right">
          <button type="button" onclick="uploadOrder(this)" class="btn btn-primary" style="margin-right: 45px"class="btn btn-primary"><i class="fa fa-arrow-right"></i>&nbsp;录入订单</button>
        </div>
        <br/>
